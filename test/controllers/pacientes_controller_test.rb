...
class PacientesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create paciente" do
    assert_difference('Paciente.count') do
      post pacientes_url, params: { paciente: { apellido: @paciente.apellido, cedula: @paciente.cedula, contrasena: @paciente.contrasena, nombre: @paciente.nombre, telefono: @paciente.telefono } }
    end
  ...
  test "should update paciente" do
    patch paciente_url(@paciente), params: { paciente: { apellido: @paciente.apellido, cedula: @paciente.cedula, contrasena: @paciente.contrasena, nombre: @paciente.nombre, telefono: @paciente.telefono } }
